...
namespace ediacaran
{
    ...
    {
      public:
        using scalar_constructor_function = void (*)(void * i_objects_start, void * i_objects_end);
        using scalar_destructor_function = void (*)(
          void * i_objects_start, void * i_objects_end) EDIACARAN_NOEXCEPT_FUNCTION_TYPE;
        ...
        constexpr special_functions(scalar_constructor_function i_scalar_default_constructor,
          scalar_destructor_function i_scalar_destructor, to_chars_function i_to_chars,
          from_chars_function i_from_chars)
        ...
        {
            return special_functions(make_default_constructor<TYPE>(), make_destructor<TYPE>(), make_to_chars<TYPE>(),
              make_from_chars<TYPE>());
        }

        constexpr scalar_constructor_function scalar_default_constructor() const noexcept
        {
            return m_scalar_default_constructor;
        }
        constexpr scalar_destructor_function scalar_destructor() const noexcept { return m_scalar_destructor; }
        constexpr to_chars_function to_chars() const noexcept { return m_to_chars; }
        constexpr from_chars_function from_chars() const noexcept { return m_from_chars; }

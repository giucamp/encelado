...
namespace ediacaran
{
    ...
    public:
        ...
        constexpr action(const char * i_name, invoke_function i_invoke_function, array_view<const parameter> const i_parameters)
            : symbol_t(i_name), m_invoke_function(i_invoke_function), m_parameters(i_parameters)
        {
    ...
    namespace detail
    {
            ...
            constexpr action make_action(const char * i_name)
        {
            ...
            return action(i_name, &action_invoker::func, action_invoker::parameters);
        }
    }

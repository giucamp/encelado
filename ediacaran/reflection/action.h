...
namespace ediacaran
{
    ...
    public:
        ...
        constexpr action(const char * i_name,
            ...
            : symbol_t(i_name), m_invoke_function(i_invoke_function), m_return_qualified_type(i_return_qualified_type), m_parameters(i_parameters)
        {
    ...
    namespace detail
    {
        ...
        template <typename OWNING_CLASS, typename RETURN_TYPE, typename... PARAMETER_TYPE, 
            ...
            struct ActionInvoker<RETURN_TYPE (OWNING_CLASS::*)(PARAMETER_TYPE...), METHOD, std::index_sequence<INDEX...>, PARAM_NAMES>
        {
        ...
        template <typename OWNING_CLASS, typename... PARAMETER_TYPE, 
                const char * const (&PARAM_NAMES)[sizeof...(PARAMETER_TYPE)],
                void (OWNING_CLASS::*METHOD)(PARAMETER_TYPE...), size_t... INDEX>
            struct ActionInvoker<void (OWNING_CLASS::*)(PARAMETER_TYPE...), METHOD, std::index_sequence<INDEX...>, PARAM_NAMES>
        {
        ...
        {
            using action_invoker = detail::ActionInvoker<METHOD_TYPE, METHOD, std::make_index_sequence<detail::MethodTraits<METHOD_TYPE>::parameter_count>, PARAM_NAMES>;
            return action(i_name, get_qualified_type<action_invoker::return_type>(), action_invoker::parameters, &action_invoker::func );
        }
    }

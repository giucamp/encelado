...
namespace ediacaran
{
    ...
    class constexpr_char_traits : public std::char_traits<char>
    {
      public:
        static constexpr void assign(
          char_type & o_dest, const char_type & i_source) noexcept
        {
            o_dest = i_source;
        }

        static constexpr void assign(char_type * i_dest, size_t i_size,
          const char_type & i_source) noexcept
        {
        ...
        constexpr static int compare(const char_type * i_first,
          const char_type * i_second, size_t i_size) noexcept
        {
            int result = 0;
    ...
    class string_view
        : public std::basic_string_view<char, constexpr_char_traits>
    {
      public:
